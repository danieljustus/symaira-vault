...
Add the dedicated Symaira bucket and install the manifest published by GoReleaser:
...
The manifest is published at the bucket root so Scoop discovers it in `scoop bucket list`.
