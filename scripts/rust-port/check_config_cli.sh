...
SYMVAULT_GO_BINARY="$oracle_binary" "${CARGO:-cargo}" test --manifest-path "$repo_root/Cargo.toml" \
    -p symvault-cli --test config_inspect --test cli_differential --test cli_error_taxonomy_differential --test cli_get_list_help_differential --test cli_dynamic_setup_help --test cli_update_help --test ui_keybindings_differential --test list_output_differential --test get_output_differential --test get_entry_output_differential --test get_empty_fields_differential --test rollback_go --test profile_differential --test remote_differential --test sync_differential --test audit_export_commands --test run_differential --test run_broker_flags_differential --test share_differential --test agent_whoami_differential --test agent_setup_deprecation_differential --test agent_list_differential --test agent_profile_differential --test agent_token_mutations_differential --test policy_differential --test path_migration_differential --test auth_differential --test audit_rotate_differential --test config_validate_differential --test doctor_differential --test setup_non_tty_differential --test cli_dynamic_generate --test cli_intake_parent_flags --test cli_intake_parent_errors_differential --test cli_intake_watch_disable --test cli_intake_watch_once --test daemon_status_differential --locked
SYMVAULT_GO_BINARY="$oracle_binary" "${CARGO:-cargo}" test --manifest-path "$repo_root/Cargo.toml" \
