...
managed_hash: sha256:50833e56c123af44c050cb22528ff5e26f488caab47a94f931fe8497e6e07b96
managed_installed_at: "2026-09-21T19:51:37Z"
...
Vault path: `/Users/daniel/.hermes/cache/scratch/fx-cd4ilbai/vault`
Agent profile: **codex** (tier: safe)

## Preferred Tools

Canonical Symaira Vault MCP tool names (codex prefix: ``):
...
For `get_entry` and write access, ask the user to run:
  symaira agent upgrade codex --tier standard
...
Codex uses `` as the tool prefix with no slash command support.

Codex agents should discover available tools on connection. Supported operations
follow the canonical tool list above.
