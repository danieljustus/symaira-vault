...
func (s *Server) handleAuditSelf(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	_ = ctx
	...
	if scanErr := scanner.Err(); scanErr != nil {
		return mcp.NewToolResultError(fmt.Sprintf("error reading audit log: %v", scanErr)), nil
	}
