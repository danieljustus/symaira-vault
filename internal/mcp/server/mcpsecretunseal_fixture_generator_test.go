...
const mcpSecretUnsealCommit = "c42b96bb4dd2a2d6cea1ade0770f55650045e5b3"
...
func TestGenerateMCPSecretUnsealFixture(t *testing.T) {
	...
	fixture := mcpSecretUnsealFixture{
		...
		Oracle: mcpCallOracle{
			Commit: "c42b96bb", CommitSHA: mcpSecretUnsealCommit, SourceFiles: mcpSecretUnsealSources,
