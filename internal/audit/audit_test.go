...
func TestLogEntryWritesJSONL(t *testing.T) {
	...
	content, err := os.ReadFile(filepath.Join(home, configpkg.DefaultVaultSubdir, "audit-test-agent.log"))
	if err != nil {
...
func TestLogEntryMultipleWrites(t *testing.T) {
	...
	content, err := os.ReadFile(filepath.Join(home, configpkg.DefaultVaultSubdir, "audit-multi-write.log"))
	if err != nil {
		t.Fatalf("ReadFile error = %v", err)
	}
...
func TestLogEntryAutoTimestamp(t *testing.T) {
	...
	content, err := os.ReadFile(filepath.Join(home, configpkg.DefaultVaultSubdir, "audit-timestamp-test.log"))
	if err != nil {
		t.Fatalf("ReadFile error = %v", err)
	}
...
func TestLogEntryPreservesProvidedTimestamp(t *testing.T) {
	...
	content, err := os.ReadFile(filepath.Join(home, configpkg.DefaultVaultSubdir, "audit-preserved-ts.log"))
	if err != nil {
		t.Fatalf("ReadFile error = %v", err)
	}
...
func TestNewCreatesAuditDirectory(t *testing.T) {
	...
	expectedDir := filepath.Join(home, configpkg.DefaultVaultSubdir)
...
func TestNewCreatesLogFile(t *testing.T) {
	...
	expectedFile := filepath.Join(home, configpkg.DefaultVaultSubdir, "audit-logfile-test.log")
...
func TestNewSetsCorrectPermissions(t *testing.T) {
	...
	expectedFile := filepath.Join(home, configpkg.DefaultVaultSubdir, "audit-perms-test.log")
...
func TestEnforceRetentionMaxBackups(t *testing.T) {
	...
	home := t.TempDir()
	t.Setenv("HOME", home)
	t.Setenv("SYMVAULT_AUDIT_MAX_SIZE_MB", "100")
	t.Setenv("SYMVAULT_AUDIT_MAX_BACKUPS", "3")
	t.Setenv("SYMVAULT_AUDIT_MAX_AGE_DAYS", "365")
...
func TestEnforceRetentionMaxAge(t *testing.T) {
	...
	t.Setenv("HOME", home)
	t.Setenv("SYMVAULT_AUDIT_MAX_SIZE_MB", "100")
	t.Setenv("SYMVAULT_AUDIT_MAX_BACKUPS", "100")
	t.Setenv("SYMVAULT_AUDIT_MAX_AGE_DAYS", "0") // 0 days = delete all
...
func TestEnforceRetentionPreservesNewest(t *testing.T) {
	...
	home := t.TempDir()
	t.Setenv("HOME", home)
	t.Setenv("SYMVAULT_AUDIT_MAX_BACKUPS", "2")
...
func TestLogEntryAutoFillsEmptyTimestamp(t *testing.T) {
	...
	content, err := os.ReadFile(filepath.Join(home, configpkg.DefaultVaultSubdir, "audit-autofill-ts-test.log"))
	if err != nil {
		t.Fatalf("ReadFile error = %v", err)
	}
...
func TestLogEntryAllFields(t *testing.T) {
	...
	content, err := os.ReadFile(filepath.Join(home, configpkg.DefaultVaultSubdir, "audit-all-fields-test.log"))
	if err != nil {
		t.Fatalf("ReadFile error = %v", err)
	}
...
func TestNewValidAgentNames(t *testing.T) {
	...
	for _, name := range validNames {
		t.Run(name, func(t *testing.T) {
			...
			expectedFile := filepath.Join(home, configpkg.DefaultVaultSubdir, fmt.Sprintf("audit-%s.log", name))
			if _, err := os.Stat(expectedFile); os.IsNotExist(err) {
...
func TestLastNEntriesCorruptedJSON(t *testing.T) {
	...
	logFile := filepath.Join(home, configpkg.DefaultVaultSubdir, "audit-corrupt-json-test.log")
	f, err := os.OpenFile(logFile, os.O_APPEND|os.O_WRONLY, 0o600)
	if err != nil {
		t.Fatalf("OpenFile() error = %v", err)
	}
...
func TestLastNEntriesMissingFields(t *testing.T) {
	...
	logFile := filepath.Join(home, configpkg.DefaultVaultSubdir, "audit-missing-fields-test.log")
	f, err := os.OpenFile(logFile, os.O_APPEND|os.O_WRONLY, 0o600)
	if err != nil {
		t.Fatalf("OpenFile() error = %v", err)
	}
...
func TestLastNEntriesEmptyTimestamp(t *testing.T) {
	...
	logFile := filepath.Join(home, configpkg.DefaultVaultSubdir, "audit-empty-ts-test.log")
	f, err := os.OpenFile(logFile, os.O_APPEND|os.O_WRONLY, 0o600)
	if err != nil {
		t.Fatalf("OpenFile() error = %v", err)
	}
...
func TestEnforceRetentionRemoveError(t *testing.T) {
	...
	home := t.TempDir()
	t.Setenv("HOME", home)
	t.Setenv("SYMVAULT_AUDIT_MAX_BACKUPS", "0") // All files should be deleted
