...
func init() {
	for k, v := range map[string]string{
		...
		"error.vault.not_initialized": "vault not initialized — run 'symaira init' first",
		"hint.unlock":                 "Unlock with 'symaira unlock', or set OPENPASS_PASSPHRASE for non-interactive use.",
		"hint.find":                   "Try: symaira find <search-term>",
		"hint.first_run":              "Run 'symaira init' for a quick start, or 'symaira setup' for the guided wizard.",
